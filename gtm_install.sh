...
COIN_CL='https://github.com/genterium-project/gentarium/releases/download/v1.1.0/gentarium-cli-linux-64'
COIN_DM='https://github.com/genterium-project/gentarium/releases/download/v1.1.0/gentariumd-linux-64'
